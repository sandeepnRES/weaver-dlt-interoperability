...
class WriteExternalStateTest2 {
    ...
    val fabricCert2 = javaClass.getResource("/test_data/fabric_cacert_org2.pem").readText(Charsets.UTF_8)
    ...
    fun `WriteExternalState2 tests`() {
        ...
        // Confidential
        val happyFuture3 = partyA.startFlow(WriteExternalStateInitiator(fabricTestData.B64View, "${fabricRelayEndpoint}/${fabricNetwork}/${fabricViewAddress}", fabricTestData.B64ViewContents))
        network.runNetwork()
        val happyLinearId3 = happyFuture3.getOrThrow()
        assertTrue(happyLinearId3.isRight())
